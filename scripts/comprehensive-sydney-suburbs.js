...
const nswSuburbs = JSON.parse(fs.readFileSync(path.join(__dirname, '../temp_data/nsw-suburbs-full.geojson'), 'utf8'));
...
const MAJOR_SYDNEY_SUBURBS = [
  ...
  'DARLINGHURST', 'POTTS POINT', 'ELIZABETH BAY', 'RUSHCUTTERS BAY', 'WOOLLOOMOOLOO',
  'KINGS CROSS', 'HAYMARKET', 'CHIPPENDALE', 'BROADWAY', 'CAMPERDOWN', 'ANNANDALE',
  'LILYFIELD', 'ROZELLE', 'BIRCHGROVE', 'BALMAIN EAST', 'MILLERS POINT', 'DAWES POINT',
  'THE ROCKS', 'BARANGAROO', 'MILSONS POINT', 'KIRRIBILLI', 'LAVENDER BAY', 'MCMAHONS POINT',
  'WAVERTON', 'WOLLSTONECRAFT', 'CROWS NEST', 'ST LEONARDS', 'GREENWICH', 'ARTARMON',
  'WILLOUGHBY', 'NAREMBURN', 'CAMMERAY', 'NORTHBRIDGE', 'CASTLECRAG', 'MIDDLE COVE',
  'CASTLE COVE', 'ROSEVILLE', 'LINDFIELD', 'KILLARA', 'GORDON', 'PYMBLE', 'TURRAMURRA',
  'WAHROONGA', 'WARRAWEE', 'THORNLEIGH', 'NORMANHURST', 'WAITARA', 'ASQUITH', 'MOUNT COLAH',
  'MOUNT KURING-GAI', 'BEROWRA', 'BEROWRA HEIGHTS', 'COWAN', 'BROOKLYN', 'MOONEY MOONEY',
  'CHEERO POINT', 'COGRA BAY', 'WONDABYNE', 'WONDABYNE', 'WONDABYNE', 'WONDABYNE'
];
