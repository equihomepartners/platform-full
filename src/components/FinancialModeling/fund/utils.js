export const calculateFundMetrics = (inputs) => {
...
export const generateRandomDeal = (inputs) => {
    ...
    const propertyValue = normalDistribution(Number(inputs.propertyValueDistribution.mean), Number(inputs.propertyValueDistribution.standardDev));
    return {
